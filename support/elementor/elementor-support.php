...
/**
 * Elementor bridge — deliberately a thin detection stub: Elementor may not
 * be installed, so there is no way to verify real widget registration
 * (Elementor\Widget_Base subclasses, `elementor/widgets/register` hook
 * name/signature, controls API) even at a basic "loads without a fatal
 * error" level against the actual installed version.
 *
 ...
 * inc/PP_Shortcodes.php and inc/PP_Blocks.php) should happen in an
